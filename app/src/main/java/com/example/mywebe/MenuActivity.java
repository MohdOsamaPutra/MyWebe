    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.clothingCard:
                i = new Intent(this, vale.class);
                startActivity(i);
                break;

            case R.id.ochaco:
                i = new Intent(this, alucard.class);
                startActivity(i);
                break;

            case R.id.almijh:
                i = new Intent(this, lancelot.class);
                startActivity(i);
                break;

            case R.id.kiana:
                i = new Intent(this, akai.class);
                startActivity(i);
                break;

            case R.id.usaginie:
                i = new Intent(this, ling.class);
                startActivity(i);
                break;

            case R.id.momoke:
                i = new Intent(this, kagura.class);
                startActivity(i);
                break;
